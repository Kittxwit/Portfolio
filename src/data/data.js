...
// Resolve image file names to importable URLs (works with Vite)
...
The system supports concurrent users and integrates seamlessly with university student and equipment databases. Since implementation, it has successfully reduced equipment loss (such as student cards) through status tracking and mandatory photo confirmation prior to rental/return, while also significantly reducing paper waste.
    ...
    image: resolveImage('1_1.png'),
    images: [resolveImage('1_1.png'), resolveImage('1_2.png'), resolveImage('1_3.png'), resolveImage('1_4.png')],
...
- Optimized for mobile screens to ensure a smooth, comfortable, and practical user experience.
    ...
    image: resolveImage('2_1.png'),
    images: [resolveImage('2_1.png'), resolveImage('2_2.png'), resolveImage('2_3.png')],
    link: 'https://hspdrmutt.com',
  },
  {
    id: 3,
...
This project focuses on creating a modern, functional smart classroom that enhances teaching and learning efficiency using smart technologies.
    ...
    image: resolveImage('3_1.png'),
    images: [resolveImage('3_1.png'), resolveImage('3_2.png'), resolveImage('3_3.png'), resolveImage('3_4.png')],
...
The design emphasizes modern and beautiful aesthetics, allowing users to browse movies, check showtimes, and book tickets conveniently. This project helped develop self-learning, problem-solving skills, and practical web design concepts.
    `,
    tech: ['HTML', 'CSS', 'MySQL'],
    image: resolveImage('4_1.png'),
    images: [resolveImage('4_1.png')],
...
- Explored render settings to optimize processing time and enhance animation output quality. This project strengthened the ability to learn new creative technologies independently.
    `,
    tech: ['Blender'],
    image: resolveImage('5_1.png'),
    images: [resolveImage('5_1.png'), resolveImage('5_2.png'), resolveImage('5_3.png')],
...
Includes an LED display for immediate, real-time onsite occupancy tracking. This project enhanced skills in IoT, sensor integration, data processing, and hardware-to-database communications.
    ...
    image: resolveImage('6_1.png'),
    images: [resolveImage('6_1.png'), resolveImage('6_2.png'), resolveImage('6_3.png')],
    link: 'https://github.com/Kittxwit/',
  },
  {
    id: 7,
...
Includes an Admin panel to manage users, monitor database entries, and ensure platform safety, enhancing communication efficiency through a modern mobile application.
    ...
    image: resolveImage('7_1.png'),
    images: [resolveImage('7_1.png'), resolveImage('7_2.png'), resolveImage('7_3.png'), resolveImage('7_4.png')],
    link: 'https://github.com/Kittxwit/',
  },
  {
    id: 8,
...
Aims to apply IoT and long-range communications to assist disaster victims, expedite search times, and maximize safety.
    ...
    image: resolveImage('8_1.png'),
    images: [resolveImage('8_1.png'), resolveImage('8_2.png')],
  ...
  experience: [
    {
      ...
      image: resolveImage('exp1.png'),
      images: [resolveImage('exp1.png'), resolveImage('exp1_1.png'), resolveImage('exp1_2.png'), resolveImage('exp1_3.png'), resolveImage('exp1_4.png'), resolveImage('exp1_5.png')],
      link: 'https://canva.link/s97orhslst795sk',
    },
  ],
  design: [
    { id: 1, title: 'GrabRader', titleEn: 'GrabRader', details: 'ออกแบบหน้าตา Feature ตามความต้องการของผู้มอบหมาย โดยใช้ Figma', detailsEn: 'Designed the feature interface according to the client\'s requirements using Figma.', image: resolveImage('design1.png'), images: [resolveImage('design1.png')] },
    { id: 2, title: 'Poster', titleEn: 'Poster', details: 'ทำโปสเตอร์สำหรับกิจกรรมต่างๆ ในสาขา', detailsEn: 'Created posters for various department events.', image: resolveImage('design2.png'), images: [resolveImage('design2.png'), resolveImage('design2_1.png'), resolveImage('design2_2.png'), resolveImage('design2_3.png')] },
    { id: 3, title: 'Sandwish', titleEn: 'Sandwich', details: 'ออกแบบโลโก้แซนด์วิช เป็นธุรกิจในห้องเรียนและประกวดธุรกิจ', detailsEn: 'Designed a sandwich logo for a classroom business and competition.', image: resolveImage('design3.png'), images: [resolveImage('design3.png'), resolveImage('design3_1.png')] },
    { id: 4, title: 'Bisou Webpage', titleEn: 'Bisou Webpage', details: 'โปรเจกต์ออกแบบหน้าเว็บไซต์ให้ธุรกิจ Bisou', detailsEn: 'Designed a webpage layout for the Bisou business.', image: resolveImage('design4.png'), images: [resolveImage('design4.png'), resolveImage('design4_1.png')] },
  ],
  activity: [
    { id: 1, title: 'SBAC Valorant', titleEn: 'SBAC Valorant', details: 'แข่งขันเกม Valorant ในการแข่งขัน SBAC', detailsEn: 'Competed in Valorant at the SBAC tournament.', image: resolveImage('activity1.png'), images: [resolveImage('activity1.png'), resolveImage('activity1_1.png')] },
    { id: 2, title: 'Present IOT Taiwan', titleEn: 'Present IoT Taiwan', details: 'พรีเซนต์โครงการ กับโปรเฟสเซอร์ที่ไต้หวันทุกสัปดาห์', detailsEn: 'Presented the project weekly to professors in Taiwan.', image: resolveImage('activity2.png'), images: [resolveImage('activity2.png'), resolveImage('activity2_1.png')] },
    { id: 3, title: 'Meeting for Internship', titleEn: 'Meeting for Internship', details: 'การพรีเซนต์แนะนำตัวเองและความสนใจในที่เกี่ยวข้องสำหรับการไปฝึกงานก่อนการไปฝึกงาน', detailsEn: 'Presented myself and my interests before the internship.', image: resolveImage('activity3.png'), images: [resolveImage('activity3.png'), resolveImage('activity3_1.png')] },
  ],
};
...
// Helper function to get single localized project
export const getLocalizedProject = (id, lang) => {
  const project = projects.find(p => p.id === id);
  return project ? localizeProject(project, lang) : null;
};

// Helper function to get localized resume data
export const getLocalizedResume = (lang) => ({
...
// Helper function to get localized experience item
export const getLocalizedExperience = (id, lang) => {
  if (id < 1 || id > resume.experience.length) return null;
  return localizeFields(resume.experience[id - 1], lang, ['role', 'company', 'period', 'details']);
};

// Helper function to get localized design item
export const getLocalizedDesign = (id, lang) => {
  const item = resume.design.find(d => d.id === id);
  return item ? localizeFields(item, lang, ['title', 'details']) : null;
};

// Helper function to get localized activity item
export const getLocalizedActivity = (id, lang) => {
  const item = resume.activity.find(a => a.id === id);
  return item ? localizeFields(item, lang, ['title', 'details']) : null;
};
